...
# Secret name in Modal: affiliate-v4-keys
...
# ============================================================
@app.function(image=image, secrets=[modal.Secret.from_name("affiliate-v4-keys")], volumes={VOLUME_PATH: volume}, schedule=modal.Period(minutes=30), timeout=3600)
...
# ============================================================
@app.function(image=image, secrets=[modal.Secret.from_name("affiliate-v4-keys")], volumes={VOLUME_PATH: volume}, schedule=modal.Cron("0 0 * * *"), timeout=1800) # 0 UTC = 5:30 AM IST
...
# ============================================================
@app.function(image=image, secrets=[modal.Secret.from_name("affiliate-v4-keys")], volumes={VOLUME_PATH: volume}, timeout=3600)
...
# ============================================================
@app.function(image=image, secrets=[modal.Secret.from_name("affiliate-v4-keys")], volumes={VOLUME_PATH: volume}, schedule=modal.Period(hours=2), timeout=1800)
def poster_auto():
...
# ============================================================
@app.function(image=image, secrets=[modal.Secret.from_name("affiliate-v4-keys")], volumes={VOLUME_PATH: volume}, schedule=modal.Cron("30 17 * * *"), timeout=1800) # 17:30 UTC = 11 PM IST
def analyst_v2():
...
# ============================================================
@app.function(image=image, secrets=[modal.Secret.from_name("affiliate-v4-keys")], volumes={VOLUME_PATH: volume}, schedule=modal.Cron("30 2 * * *"), timeout=900) # 2:30 UTC = 8 AM IST
...
# ============================================================
@app.function(image=image, secrets=[modal.Secret.from_name("affiliate-v4-keys")], volumes={VOLUME_PATH: volume})
...
def dashboard_home():
    ...
    """
    return modal.Response(html, media_type="text/html")
